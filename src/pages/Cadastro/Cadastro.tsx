  ...
  return (
    <>
      ...
      <main class="main_cadastro">
        <h1 class="visualmente_oculto">Tela de cadastro e listagem de produtos</h1>
        <form>
          <h2>Cadastro</h2>
          <hr>
            <div class="container container_cadastro">
              <div class="cadastro_col1">
                <div class="campo campo_bolo">
                  <label for="bolo">Bolo</label>
                  <input id="bolo" type="text">
                </div>
                <div class="linha_cat_img">
                  <div class="campo campo_categoria">
                    <label for="categoria">Categorias</label>
                    <input id="categoria" type="text">
                  </div>
                  <div class="campo campo_img">
                    <label for="img">
                      <span>Imagem</span>
                      <div>
                ...
                <div class="linha_val_peso">
                  <div class="campo campo_valor">
                    <label for="valor">Valor</label>
                    <input id="valor" type="text">
                  </div>
                  <div class="campo campo_peso">
                    <label for="peso">Peso</label>
                    <input id="peso" type="text">
                  </div>
                </div>
              </div>
              <div class="campo cadastro_col2">
